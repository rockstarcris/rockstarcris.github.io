import{w as ee}from"./index.d2456d52.js";import{q as te,e as ne,w as se,f as re,c as oe,_ as ie,C as ae,r as S,S as ue,F as ce,h as C,j as le,k as he,l as de,m as fe}from"./index.esm.a0d8edf4.js";const pe=ee(),gt=(e,t,n)=>new Promise((s,r)=>{const o=pe.subscribe(async i=>{if(i){setTimeout(()=>{o()},0);try{if(n){const a=te(ne(i,e),se(t==="doc_id"?re():t,"==",n)),c=(await oe(a)).docs.map(p=>p.data());s(c)}else r("The valor is empty.")}catch(a){r(a)}}})});/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function De(e,t,n){let s=1,r=null,o=null,i=!1,a=0;function u(){return a===2}let c=!1;function p(..._){c||(c=!0,t.apply(null,_))}function R(_){r=setTimeout(()=>{r=null,e(w,u())},_)}function m(){o&&clearTimeout(o)}function w(_,...N){if(c){m();return}if(_){m(),p.call(null,_,...N);return}if(u()||i){m(),p.call(null,_,...N);return}s<64&&(s*=2);let E;a===1?(a=2,E=0):E=(s+Math.random())*1e3,R(E)}let T=!1;function I(_){T||(T=!0,m(),!c&&(r!==null?(_||(a=2),clearTimeout(r),R(0)):_||(a=1)))}return R(0),o=setTimeout(()=>{i=!0,I(!0)},n),I}function ve(e){e(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
